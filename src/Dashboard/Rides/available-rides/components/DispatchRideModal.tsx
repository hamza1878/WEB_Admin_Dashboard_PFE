      ...
      <div style={modalBase}>
        ...
        <div style={modalBody}>
          ...
          >
            ...
            >
              ⚠ Manual override — dispatch is handled automatically by the
              system. Use this only if a ride appears stuck or needs immediate
              attention.
            </p>
          </div>
          ...
          >
            ...
            <div
              style={{
                ...cardInner,
                padding: ".875rem 1rem",
                border: `1.5px dashed ${T.violetBorder}`,
          ...
          <StatsGrid
            stats={[
              ...
              {
                label: "Distance",
                value: ride.distanceKm ? `${ride.distanceKm} km` : "—",
                icon: (
              ...
              {
                label: "Duration",
                value: ride.durationMin ? `${ride.durationMin} min` : "—",
                icon: (
                  <AccessTimeRoundedIcon
          ...
          {needsConfirm && (
            ...
            >
              ...
              >
                ⚠ This ride is PENDING. It will be confirmed automatically
                before dispatch.
              </p>
            </div>
          )}
          ...
          <div style={{ ...cardInner, padding: ".75rem 1rem" }}>
            <p style={{ fontSize: ".75rem", color: T.textSub, margin: 0 }}>
              This will immediately trigger the dispatch pipeline, bypassing the
              automatic scheduler. The system will find the best available
              driver based on distance, rating, and vehicle class.
            </p>
          </div>
        </div>
