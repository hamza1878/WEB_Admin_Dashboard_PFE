...
export const VEHICLE_CLASSES = [
  {
    key: "Economy",
    label: "Economy",
    examples: ["Skoda Octavia", "Toyota Prius", "Hyundai Ioniq"],
  },
  {
    key: "Standard",
    label: "Standard",
    examples: ["Mercedes E-Class", "BMW 5 Series", "Cadillac XTS"],
  },
  {
    key: "Comfort",
    label: "Comfort",
    examples: ["Mercedes C-Class", "Audi A6", "Lexus ES"],
  },
  {
    key: "First Class",
    label: "First Class",
  ...
  },
  {
    key: "Van",
    label: "Van",
    examples: ["Mercedes Vito", "Ford Custom", "Chevrolet Suburban"],
  },
  {
    key: "Mini Bus",
    label: "Mini Bus",
    examples: ["Mercedes Sprinter", "Volkswagen Crafter", "Iveco Daily"],
  },
] as const;
...
export const EMPTY_ERRS: ErrState = {
  make: "",
  model: "",
  year: "",
  color: "",
